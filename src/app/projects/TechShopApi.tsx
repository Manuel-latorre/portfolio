...
export default function TechShopApi(){
    ...
    return(
        <div id="projects" className="flex flex-col w-9/12 mx-auto max-xl:w-full max-xl:p-10">
            <div>
              <p className="font-bold text-5xl text-white text-center xl:mb-10">Proyectos</p>
            </div> 
            ...
            <div className="flex items-start justify-between max-xl:flex-col">
                <div className="xl:w-2/4 mt-10">
                    <p className="text-zinc-300">Se trata de un sitio web que ofrece una API Rest que cuenta con una gran cantidad de prodcutos tecnológicos como auriculares, teclados, consolas y más. 
                        Además cuenta con un carrito para almacenar productos y tambien con usuarios. En la seccion de Docs se encuentra toda la información necesaria para consumir la API ya que cuenta con ya que cuenta con un CRUD(Create, Read, Update, Delete) completo
                    </p>
                    <div className="flex items-center gap-5 mt-5">
                        ...
                        <Button as={Link} href="https://github.com/Manuel-latorre/website-api" variant="shadow" color="default" size="sm" className="flex items-center" target="_blank">
