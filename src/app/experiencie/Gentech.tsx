    ...
    return(
        <div className="flex flex-col w-9/12 mx-auto max-xl:w-full max-xl:p-10"> 
            ...
            <div className="mt-2 flex flex-col gap-3">
                ...
                <p className="text-sm text-white">Agosto 2023 - Octubre 2023</p>
            </div>
            <div className="flex items-center justify-between max-xl:flex-col">
                <div className="xl:w-2/4">
                    <p className="text-zinc-300">Durante el desarrollo de Generación Tech, que se trata de un SPA(Single Page Application). Esta es una agencia de servicios digitales, en la cual he llevado a código el diseño acordado por el equipo de diseño.
                        Cuenta con un responsive-design, interfaz de usuario intuitiva y más.
                    </p>
                    ...
                    <ul className="mt-3 flex flex-col gap-4">
                        <li className="flex items-center gap-2">
                            ...
                            <p className="text-zinc-300">
                                Integrar mediante la librería Email Js la opcion de comunicarse via email directamente desde el sitio web
                            </p>
                        </li>
                    </ul>
                        <p className="text-zinc-300 font-bold mt-5">Tecnologías utilizadas</p>
