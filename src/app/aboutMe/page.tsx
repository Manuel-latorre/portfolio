...
export default function AboutMe(){
    return(
        <div className="flex items-center justify-evenly max-lg:flex-col max-lg:p-10 max-lg:mx-auto max-lg:justify-center lg:mt-32">
            <div className="flex flex-col gap-1 lg:w-5/12 max-lg:justify-center my-10">
                ...
                <div className="flex items-center gap-7 mt-5 max-lg:justify-center">
